...
> goods(goods_id, goods_name, goods_type, number_c)
...
> sale(sale_id, sale_name, sale_price, logout)

- sale_id：主键，整型，自增
- sale_name：不唯一，varchar
- sale_price：小数，decimal
...
> purchase(purchase_id, goods_id, customer_id, number_s)
